...
<script src="${process.env.NEXT_PUBLIC_APP_URL ?? "https://app.meetzy.ai"}/widget.js" async></script>`;
  ...
  return (
    <article className="product-site-card flex flex-col overflow-hidden p-0">
      {/* Card header — 60px */}
      <header
        className="flex h-[72px] sm:h-[80px] items-center gap-3 sm:gap-4 border-b border-[var(--border-subtle)] px-4 sm:px-6"
        style={{
      ...
      <div className="grid grid-cols-3 divide-x divide-[var(--border-subtle)] px-0 py-0">
        <div className="px-3 py-4 sm:px-5 sm:py-5 text-center">
          <p className="font-mono text-[20px] sm:text-[22px] font-medium tabular-nums leading-tight text-[var(--text-primary)]">
        ...
        <div className="flex flex-col items-center justify-center px-3 py-4 sm:px-5 sm:py-5">
          <span
      ...
      {/* Footer */}
      <footer className="flex items-center justify-between border-t border-[var(--border-subtle)] px-4 sm:px-6 py-3 sm:py-4">
      ...
      <div className="flex items-center justify-between border-t border-[var(--border-subtle)] px-4 sm:px-6 py-3">
        <a
