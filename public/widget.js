...
"use strict";(()=>{function J(t,i=50){let n=parseInt(t.slice(1,3),16),e=parseInt(t.slice(3,5),16),a=parseInt(t.slice(5,7),16);return`rgb(${Math.min(255,n+i)},${Math.min(255,e+i)},${Math.min(255,a+i)})`}function O(t,i,n,e,a,r){let s=r.subtype==="female",o=s?"#f5c5a0":"#e8b88a",c=s?"#4a2c0a":"#2c1a0a";t.save(),t.translate(i,n+a.breathePhase*1.5*e),t.fillStyle=r.brandColor,t.beginPath(),t.roundRect(-28*e,30*e,56*e,55*e,8*e),t.fill(),t.fillStyle="rgba(255,255,255,0.8)",t.font=`bold ${13*e}px sans-serif`,t.textAlign="center",t.textBaseline="middle",t.fillText("M",i,n+55*e),t.fillStyle=r.brandColor,t.beginPath(),t.roundRect(-44*e,32*e,17*e,42*e,6*e),t.fill(),t.beginPath(),t.roundRect(27*e,32*e,17*e,42*e,6*e),t.fill(),t.fillStyle=o,t.beginPath(),t.roundRect(-8*e,8*e,16*e,22*e,4*e),t.fill(),t.save(),t.translate(a.headWobble*e,0),t.fillStyle=c,s?(t.beginPath(),t.ellipse(i,n-32*e,34*e,38*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.roundRect(i-33*e,n-35*e,11*e,55*e,6*e),t.fill(),t.beginPath(),t.roundRect(i+22*e,n-35*e,11*e,55*e,6*e),t.fill()):(t.beginPath(),t.ellipse(i,n-34*e,29*e,22*e,0,0,Math.PI),t.fill()),t.fillStyle=o,t.beginPath(),t.ellipse(i,n-20*e,29*e,33*e,0,0,Math.PI*2),t.fill();let d=n-26*e,l=a.blinkProgress;t.fillStyle="#fff",t.beginPath(),t.ellipse(i-10*e,d,8*e,8*l*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+10*e,d,8*e,8*l*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#2c1a0a",t.beginPath(),t.ellipse(i-10*e,d,5*e,5*l*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+10*e,d,5*e,5*l*e,0,0,Math.PI*2),t.fill(),t.fillStyle="rgba(255,255,255,0.6)",t.beginPath(),t.ellipse(i-8*e,d-2*e,2*e,2*l*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+12*e,d-2*e,2*e,2*l*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#c0392b",t.beginPath(),t.ellipse(i,n-5*e,10*e,(3+a.mouthOpen*5)*e,0,0,Math.PI),t.fill(),t.restore(),t.restore()}function Z(t,i,n,e,a,r){t.save(),t.translate(i,n+a.breathePhase*1.5*e),t.fillStyle=r.brandColor,t.beginPath(),t.roundRect(-30*e,20*e,60*e,65*e,10*e),t.fill(),t.save(),t.translate(a.headWobble*e,0),t.fillStyle="#8B5E3C",t.beginPath(),t.ellipse(i-28*e,n-18*e,13*e,20*e,-.4,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+28*e,n-18*e,13*e,20*e,.4,0,Math.PI*2),t.fill(),t.fillStyle="#c4895f",t.beginPath(),t.ellipse(i,n-15*e,33*e,30*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#e0b080",t.beginPath(),t.ellipse(i,n,16*e,13*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#1a1a1a",t.beginPath(),t.ellipse(i,n-4*e,6*e,5*e,0,0,Math.PI*2),t.fill();let s=a.blinkProgress;t.fillStyle="#fff",t.beginPath(),t.ellipse(i-14*e,n-22*e,8*e,8*s*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+14*e,n-22*e,8*e,8*s*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#2c1a0a",t.beginPath(),t.ellipse(i-14*e,n-22*e,5*e,5*s*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+14*e,n-22*e,5*e,5*s*e,0,0,Math.PI*2),t.fill(),t.strokeStyle="#6b3a1f",t.lineWidth=2*e,t.beginPath(),t.moveTo(i-8*e,n+6*e),t.quadraticCurveTo(i,n+(10+a.mouthOpen*8)*e,i+8*e,n+6*e),t.stroke(),t.restore(),t.restore()}function K(t,i,n,e,a){let r=a.isTalking?Math.abs(Math.sin(a.frame*.3))*5:0;t.save(),t.translate(i,n-r*e+a.breathePhase*1.5*e);let s=t.createRadialGradient(-14*e,n-20*e,4*e,0,n+10*e,52*e);s.addColorStop(0,"#ffa030"),s.addColorStop(1,"#e05800"),t.fillStyle=s,t.beginPath(),t.arc(0,n+10*e,52*e,0,Math.PI*2),t.fill(),t.fillStyle="#2ea032",t.beginPath(),t.ellipse(5*e,n-46*e,7*e,17*e,.5,0,Math.PI*2),t.fill(),t.strokeStyle="#4a2c0a",t.lineWidth=3*e,t.beginPath(),t.moveTo(0,n-42*e),t.quadraticCurveTo(5*e,n-56*e,0,n-62*e),t.stroke();let o=a.blinkProgress;t.fillStyle="#fff",t.beginPath(),t.ellipse(-16*e,n-5*e,9*e,9*o*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(16*e,n-5*e,9*e,9*o*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#1a1a1a",t.beginPath(),t.ellipse(-16*e,n-5*e,5*e,5*o*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(16*e,n-5*e,5*e,5*o*e,0,0,Math.PI*2),t.fill(),t.strokeStyle="#c05000",t.lineWidth=3*e,t.beginPath(),t.arc(0,n+10*e,15*e,.2,Math.PI-.2),t.stroke(),a.mouthOpen>.1&&(t.fillStyle="#c05000",t.beginPath(),t.ellipse(0,n+20*e,10*e,(3+a.mouthOpen*7)*e,0,0,Math.PI),t.fill()),t.restore()}function ee(t,i,n,e,a,r){t.save(),t.translate(i,n+a.breathePhase*1.5*e),t.strokeStyle=r.brandColor,t.lineWidth=7*e,t.beginPath(),t.arc(i+40*e,n+15*e,17*e,-.8,.8),t.stroke(),t.fillStyle=r.brandColor,t.beginPath(),t.moveTo(i-28*e,n-30*e),t.lineTo(i-33*e,n+48*e),t.quadraticCurveTo(i,n+60*e,i+33*e,n+48*e),t.lineTo(i+28*e,n-30*e),t.closePath(),t.fill(),t.fillStyle=J(r.brandColor,40),t.beginPath(),t.ellipse(i,n-30*e,28*e,7*e,0,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(255,255,255,0.25)",t.lineWidth=2.5*e;let s=a.frame*2%20;for(let c=-1;c<=1;c++)t.beginPath(),t.moveTo(i+c*9*e,n-38*e-s*e),t.quadraticCurveTo(i+(c+1)*7*e,n-52*e-s*e,i+c*7*e,n-65*e-s*e),t.stroke();let o=a.blinkProgress;t.fillStyle="#fff",t.beginPath(),t.ellipse(i-10*e,n-5*e,8*e,8*o*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+10*e,n-5*e,8*e,8*o*e,0,0,Math.PI*2),t.fill(),t.fillStyle="#1a1a1a",t.beginPath(),t.ellipse(i-10*e,n-5*e,5*e,5*o*e,0,0,Math.PI*2),t.fill(),t.beginPath(),t.ellipse(i+10*e,n-5*e,5*e,5*o*e,0,0,Math.PI*2),t.fill(),t.strokeStyle="rgba(255,255,255,0.8)",t.lineWidth=2.5*e,t.beginPath(),t.arc(i,n+15*e,11*e,.2,Math.PI-.2),t.stroke(),a.mouthOpen>.1&&(t.fillStyle="rgba(0,0,0,0.35)",t.beginPath(),t.ellipse(i,n+22*e,8*e,(2+a.mouthOpen*6)*e,0,0,Math.PI),t.fill()),t.restore()}var S=class{constructor(i,n){this.raf=0;this.canvas=i,this.ctx=i.getContext("2d"),this.config=n,this.state={blinkTimer:150+Math.random()*100,blinkProgress:1,breathePhase:0,mouthOpen:0,headWobble:0,wobbleDir:1,frame:0,isTalking:!1}}setTalking(i){this.state.isTalking=i}updateConfig(i){this.config={...this.config,...i}}start(){let i=()=>{var s,o;let n=this.state,e=this.canvas.width/200,a=this.canvas.width/2,r=this.canvas.height/2;switch(this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height),n.frame++,n.breathePhase=Math.sin(n.frame*.02),n.blinkTimer--,n.blinkTimer<=0&&(n.blinkTimer=180+Math.random()*120),n.blinkTimer<10?n.blinkProgress=n.blinkTimer<5?n.blinkTimer/5:(10-n.blinkTimer)/5:n.blinkProgress=1,n.headWobble+=n.wobbleDir*.04,Math.abs(n.headWobble)>1.5&&(n.wobbleDir*=-1),n.isTalking?n.mouthOpen=.3+Math.sin(n.frame*.25)*.4:n.mouthOpen=Math.max(0,n.mouthOpen-.08),this.config.type){case"human":O(this.ctx,a,r,e,n,this.config);break;case"animal":Z(this.ctx,a,r,e,n,this.config);break;case"object":(s=this.config.subtype)!=null&&s.includes("taza")||(o=this.config.subtype)!=null&&o.includes("cup")?ee(this.ctx,a,r,e,n,this.config):K(this.ctx,a,r,e,n);break;default:O(this.ctx,a,r,e,n,this.config)}this.raf=requestAnimationFrame(i)};this.raf=requestAnimationFrame(i)}stop(){cancelAnimationFrame(this.raf)}};function q(t,i){let n=t.data;switch(t.type){case"card":return te(n,i);case"gallery":return ie(n);case"booking":return ne(n,i);case"pricing":return ae(n,i);case"contact":return re(n,i);default:return document.createElement("div")}}function te(t,i){var s;let n=document.createElement("div");if(n.className="mz-ui-card",n.style.cssText=`
  ...
  `,r.textContent=t.ctaText,r.onmouseenter=()=>r.style.opacity="0.85",r.onmouseleave=()=>r.style.opacity="1",e.appendChild(r),n.appendChild(e),n}function ie(t){let i=document.createElement("div");i.style.cssText="margin: 8px 0;";let n=document.createElement("div");if(n.style.cssText="display:flex; gap:8px; overflow-x:auto; padding-bottom:6px; scrollbar-width:thin;",t.images.slice(0,6).forEach(e=>{var s;let a=document.createElement("div");a.style.cssText="flex-shrink:0; width:110px;";let r=document.createElement("img");r.src=e.url,r.alt=(s=e.alt)!=null?s:"",r.style.cssText="width:110px; height:80px; object-fit:cover; border-radius:10px;",a.appendChild(r),n.appendChild(a)}),t.caption){let e=document.createElement("p");e.style.cssText="color: #6b6b6b; font-size: 11px; margin: 6px 0 0;",e.textContent=t.caption,i.appendChild(e)}return i.appendChild(n),i}function ne(t,i){var r;let n=document.createElement("div");n.style.cssText=`
  ...
  `,a.textContent="\u{1F4C5} Reservar reuni\xF3n",n.appendChild(a),n}function ae(t,i){let n=document.createElement("div");n.style.cssText="margin: 8px 0;";let e=document.createElement("div");return e.style.cssText="display:flex; gap:8px; overflow-x:auto; padding-bottom:6px;",t.plans.forEach(a=>{let r=document.createElement("div");r.style.cssText=`
    ...
    `;let s=document.createElement("p");s.style.cssText="color: #6b6b6b; font-size: 11px; font-weight: 700; text-transform:uppercase; letter-spacing:0.05em; margin:0 0 4px;",s.textContent=a.name,r.appendChild(s);let o=document.createElement("p");o.style.cssText=`color: ${a.highlighted?i:"#F0EDE8"}; font-weight: 700; font-size: 20px; margin: 0 0 10px;`,o.textContent=a.price,r.appendChild(o);let c=document.createElement("ul");if(c.style.cssText="margin:0 0 12px; padding: 0 0 0 14px;",a.features.slice(0,4).forEach(d=>{let l=document.createElement("li");l.style.cssText="color: #a0a0a0; font-size: 11px; margin-bottom: 4px;",l.textContent=d,c.appendChild(l)}),r.appendChild(c),a.ctaUrl){let d=document.createElement("a");d.href=a.ctaUrl,d.target="_blank",d.style.cssText=`
      ...
      `,d.textContent="Elegir plan",r.appendChild(d)}e.appendChild(r)}),n.appendChild(e),n}function re(t,i){let n=document.createElement("div");n.style.cssText=`
    background: #1a1a1a; border: 1px solid #2a2a2a;
    border-radius: 16px; padding: 16px; margin: 8px 0;
...
`))if(x.startsWith("data: "))try{let g=JSON.parse(x.slice(6));if(g.type==="text"&&g.content&&(h+=g.content,r.textContent=h.replace(/\[ACTION:[^\]]+\]/g,"").trimEnd(),this.msgsEl.scrollTop=9999),g.type==="ui_component"&&g.component){let C=q(g.component,this.config.brandColor);this.msgsEl.appendChild(C),this.msgsEl.scrollTop=9999}}catch(g){}}this.updateChips(s.currentSection)}catch(d){r.textContent="Error de conexi\xF3n."}finally{this.isStreaming=!1,(c=this.avatarRenderer)==null||c.setTalking(!1),a==null||a.classList.remove("mz-talk")}}evaluateTriggers(){if(this.state==="chat")return;let i=this.tracker.get(),n=this.triggers.evaluate(i);if(!n)return;let e=this.triggers.getMessage(n,i);this.showMessage(e)}css(){let i=this.config.brandColor,n=this.config.widgetPosition==="bottom-left";return`
  ...
  </style>`;let r=document.createElement("div");r.className="w",e.appendChild(r);let s=document.createElement("div");s.className="s";let o=document.createElement("div");o.className="av";let c=($=i.avatarImageUrl)==null?void 0:$.trim();if(c){let p=document.createElement("img");p.className="mz-avatar-img",p.src=c,p.alt="",o.appendChild(p)}else o.textContent=i.agentName.slice(0,2).toUpperCase();s.appendChild(o);let d=document.createElement("div");d.className="an",d.textContent=i.agentName,s.appendChild(d);let l=document.createElement("div");l.className="ar",l.innerHTML=`<span class="ad"></span>${i.agentRole}`,s.appendChild(l),r.appendChild(s);let f=document.createElement("div");f.className="c";let w=document.createElement("div");w.className="m",w.id="fp-msgs",f.appendChild(w);let h=document.createElement("div");h.className="ia";let m=document.createElement("textarea");m.className="it",m.placeholder="Contame qu\xE9 necesit\xE1s\u2026",m.rows=1,m.addEventListener("input",()=>{m.style.height="auto",m.style.height=Math.min(m.scrollHeight,110)+"px"}),h.appendChild(m);let v=document.createElement("button");v.className="sb",v.innerHTML='<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M22 2L11 13M22 2L15 22L11 13M11 13L2 9" stroke="white" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',h.appendChild(v),f.appendChild(h),r.appendChild(f);let x=(()=>{let p=localStorage.getItem("mz_uid");return p||(p=Math.random().toString(36).slice(2),localStorage.setItem("mz_uid",p)),p})(),g,C=!1,Y=Date.now(),_=!1;function N(){if(_||!g)return;_=!0;let p=Math.round((Date.now()-Y)/1e3),u=new URLSearchParams(location.search);fetch(`${k}/api/sessions/end`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({conversationId:g,visitorId:x,siteId:t,sessionDuration:p,activeTime:p,pagesVisited:[location.pathname],scrollDepth:0,device:/Mobile/i.test(navigator.userAgent)?"mobile":"desktop",browser:navigator.userAgent.includes("Chrome")?"chrome":"other",referrer:document.referrer||null,utmSource:u.get("utm_source"),utmMedium:u.get("utm_medium"),utmCampaign:u.get("utm_campaign")}),keepalive:!0}).catch(()=>{})}window.addEventListener("beforeunload",N),document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&N()});function H(p,u){u=(u||"").replace(/\[ACTION:[^\]]+\]/g,"").trim();let E=e.getElementById("fp-msgs"),b=document.createElement("div");b.className=`mw m${p}`;let y=document.createElement("div");return y.className=`mb mb${p}`,y.textContent=u,b.appendChild(y),E.appendChild(b),E.scrollTop=9999,y}H("a",i.welcomeMessage);async function R(p){if(C)return;m.value="",m.style.height="auto",H("u",p),C=!0;let u=e.getElementById("fp-msgs"),E=document.createElement("div");E.className="mw ma";let b=document.createElement("div");b.className="mb mba",b.innerHTML='<span class="typing"><span></span><span></span><span></span></span>',E.appendChild(b),u.appendChild(E),u.scrollTop=9999;try{let y=new URLSearchParams(location.search),P=await fetch(`${k}/api/chat`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({siteId:t,message:p,conversationId:g,visitorId:x,plan:i.plan,referrer:document.referrer||null,utmSource:y.get("utm_source"),utmMedium:y.get("utm_medium"),utmCampaign:y.get("utm_campaign")})});if(!P.ok||!P.body){b.textContent="Error.";return}let L=P.headers.get("X-Conversation-Id");L&&(L!==g&&(_=!1),g=L);let j=P.body.getReader(),G=new TextDecoder,V="";for(b.textContent="";;){let{done:Q,value:X}=await j.read();if(Q)break;for(let A of G.decode(X).split(`
`))if(A.startsWith("data: "))try{let M=JSON.parse(A.slice(6));M.type==="text"&&M.content&&(V+=M.content,b.textContent=V.replace(/\[ACTION:[^\]]+\]/g,"").trimEnd(),u.scrollTop=9999)}catch(M){}}}catch(y){b.textContent="Error."}finally{C=!1}}m.addEventListener("keydown",p=>{if(p.key==="Enter"&&!p.shiftKey){p.preventDefault();let u=m.value.trim();u&&!C&&R(u)}}),v.addEventListener("click",()=>{let p=m.value.trim();p&&!C&&R(p)})}async function B(){if(document.getElementById("meetzy-widget"))return;var n,e,a;let t=(n=window.MEETZYCONFIG)==null?void 0:n.siteId;if(!t)return;window._mzWidgetInit=(e=window._mzWidgetInit)!=null?e:Date.now();let i;try{let r=await fetch(`${k}/api/sites/${t}/config`);if(!r.ok)return;let s=await r.json();if(i={...s,avatarImageUrl:(a=s.avatarImageUrl)!=null?a:null},!i.isActive)return}catch(r){return}if(i.embedMode==="fullpage"){de(t,i);return}new z(t,i).init()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",B):B();})();
